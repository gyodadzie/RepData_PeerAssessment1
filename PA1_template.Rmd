...
The mean of the total number of steps taken per day is **`r s_mean`**

The median of the total number of steps taken per day is **`r s_median`**
...
Do these values differ from the estimates from the first part of the assignment? **Taking a difference of mean and median respectively  *(`r s_mean - mean(total_steps)`* , *`r s_median - median(total_steps)`)*, the values deviate slightly**.
